...
path_to_backup = '/netology/vk_backup/1/2/3/'

ya.get_new_folder_path(path_to_backup)

def backup_profile_fotos_to_yandex(path_to_save):
    fotos = vk.get_photos_from_albom()
    # pprint(fotos)
    json_data = []
    ...
    with open('fotos_info.json', 'w') as f:
        json.dump(json_data, f)
    ya.upload_file_to_disk(path_to_save + 'fotos_info.json', 'fotos_info.json')




backup_profile_fotos_to_yandex(path_to_backup)
